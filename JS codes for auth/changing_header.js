        ...
        function checkAuthStatus() {
            ...
            if (isLoggedIn === 'true' || userData) {
                ...
                authButton.className = 'dashboard-btn';
                authButton.href = '#dashboard'; // Update href to dashboard page
            } else {
                // User is not logged in - show LogIn/Register button
                authButton.textContent = 'LogIn/Register';
                authButton.className = 'Nav-btn';
                authButton.href = '#login'; // Update href to login page
            }
        }
        ...
        document.getElementById('authButton').addEventListener('click', function(e) {
            ...
            if (isLoggedIn) {
                ...
                alert('Would redirect to dashboard page');
            } else {
